...
@section('content')
 ...
 <a href="{{ url('home')}}">Home </a>&nbsp;&nbsp; /&nbsp;&nbsp;<a href="{{ url('manage')}}"> Manage</a>&nbsp;&nbsp;/&nbsp;&nbsp; <a href="{{ url('setting')}}"> Settings </a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="" style="color:#2F76A5;">Edit Publication Type</a></h5>
  </div>
  <div class="pull-left">
...
<div class="col-lg-8 col-md-8 col-sm-8" >
 ...
 <center>  <h3>PUBLICATION TYPES</h3>
        <table class="table table-striped" style="width:70%;">
    <tr>
      <form method="POST" action="{{url('edit-type')}}">
          {{csrf_field()}}
      <th>No</th>
    ...
    <tr>
      ...
      <td><input type="text" name="type" value="{{$pubs->type}}" class="form-control" placeholder="Centre Name"></td>
      
    </tr>
    <tr>
      <td colspan="2"> <input type="submit" value="Update Publication Type" name="submit" class="btn btn-primary" style="margin-left: 30%" ></td>
