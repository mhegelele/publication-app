    ...
    @endif
               <form method="POST" action="{{ route('register') }}">
                       {{ csrf_field()}}
                                    ...
                                    @if($errors->has('name'))<p class="danger">{{$errors->first('name')}}</p>@endif
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Official Email @nimr.or.tz*" value="{{old('email')}}" name="email" />
                                     ...
                                     @if($errors->has('email2'))<p>{{$errors->first('email2')}}</p>@endif
                                       ...
                                       <div class="form-group">
                                        <!-- <input id="password-confirm" type="password" class="form-control" name="password_confirmation" required autocomplete="new-password"> -->
                                            <input type="password"  class="form-control @error('cpassword') is-invalid @enderror" name="password_confirmation" placeholder="Confirm Password *" required autocomplete="new-password" />
