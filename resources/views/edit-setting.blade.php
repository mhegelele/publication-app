...
<div class="col-lg-8 col-md-8 col-sm-8" >
 ...
 <center>  <h3>CENTRES</h3>
        <table class="table table-striped" style="width:70%;">
    <tr>
      <form method="POST" action="{{url('editcentre')}}">
          {{csrf_field()}}
      <th>No</th>
      <th>Centre Name</th>
    ...
    <tr>
      ...
      <td><input type="text" name="c_name" value="{{$pubs->c_name}}" class="form-control" placeholder="Centre Name"></td>
      
    </tr>
    <tr>
      <td colspan="2"> <input type="submit" value="Update Centre" name="submit" class="btn btn-primary" style="margin-left: 30%" ></td>
