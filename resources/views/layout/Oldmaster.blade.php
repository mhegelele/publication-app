...
<form method="post" action="{{url('search')}}" class="form-inline">
   <div class="form-group">
     <div class="input-group">
      <input name="search" class="form-control" placeholder="Search for..." type="text">
      <span class="input-group-btn">{{csrf_field()}}
    ...
    <main>
        <section class="cd-section index cd-selected">
            <header>
                <div class="cd-title">
                    <h2>This area will contain NIMR Logo, na vingine vingi tu</h2>
                </div> 
            </header>
        </section>
